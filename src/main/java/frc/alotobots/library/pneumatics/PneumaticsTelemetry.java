...
public class PneumaticsTelemetry {
  ...
  private GenericEntry initializeShuffleboard() {
    return pneumaticsTab
        .add("Compressor State", "Unknown")
        .withPosition(0, 0)
        .withSize(2, 1)
        .getEntry();
  }
  ...
  private GenericEntry initializePressureSwitchEntry() {
    return pneumaticsTab.add("Pressure Switch", false).withPosition(0, 1).withSize(2, 1).getEntry();
  }
