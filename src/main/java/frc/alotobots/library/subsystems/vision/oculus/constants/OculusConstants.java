 ...
 * Contains configuration values for physical setup and operation parameters.
 */
public class OculusConstants {
   ...
   * If a reset operation takes longer than this time, it will be considered failed.
   */
  public static final double RESET_TIMEOUT_SECONDS = 0.2;

  /**
   * Maximum number of attempts for reset operations.
   * If a reset operation fails this many times, the command will terminate.
   */
   ...
   * By default, the Quest 3 provides sub-millimeter accuracy.
   * Values represent:
   * [0]: X position trust (5mm)
   * [1]: Y position trust (5mm)
   * [2]: Rotation trust (~2.87 degrees)
   */
